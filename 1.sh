...
echo ""
echo "The following gdisk commands would be used:"
echo ""
echo "o      # Create a new empty GPT"
echo "n      # New partition: BOOT"
echo "       # Partition number: 1"
echo "       # First sector: (default: $PART_BOOT_START)"
echo "       # Last sector: +${BOOT_MIB}M"
echo "       # Hex code: ef00"
echo "n      # New partition: SWAP"
echo "       # Partition number: 2"
echo "       # First sector: (default: $PART_SWAP_START)"
echo "       # Last sector: +${SWAP_MIB}M"
echo "       # Hex code: 8200"
echo "n      # New partition: ROOT"
echo "       # Partition number: 3"
echo "       # First sector: (default: $PART_ROOT_START)"
echo "       # Last sector: +${ROOT_MIB}M"
echo "       # Hex code: 8300"
echo "n      # New partition: HOME"
echo "       # Partition number: 4"
echo "       # First sector: (default: $PART_HOME_START)"
echo "       # Last sector: (default, rest of drive)"#!/bin/bash
...
echo "       # Partition number: 4"
echo "       # First sector: (default: $PART_HOME_START)"
echo "       # Last sector: (default, rest of drive)"
echo "       # Hex code: 8300"
echo "w      # Write table and exit"
echo ""

echo "To actually partition, you can run:"
echo "gdisk $DRIVE"
echo "Then enter the above commands interactively, or use a here-document."
echo ""
echo "Example (non-interactive):"
echo "gdisk $DRIVE <<EOF
o
n
1
...
echo "Partitioning complete (dry run). Please review before proceeding for real!"
echo "       # Hex code: 8300"
echo "w      # Write table and exit"
echo ""
